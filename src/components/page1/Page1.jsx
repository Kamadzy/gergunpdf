      ...
      <div className="container">
        <div className="page1-content">
          ...
          <div className="table-headline">
            ...
            <div className="row table-headline-checkbox">
              <p>
                If don't have any experience in the operation of motor vehicles please, check here:
              </p>
              <Checkbox
                name="expCheck"
        ...
        <div className="page2-content">
          ...
          <div className="page2-sign">
            ...
            <p className="page2-sign-p">
              ...
              and information in it are true and complete to the best of my knowledge. I authorize
              you to <br />
              ...
              employment <br /> decision. (Generally, inquiries regarding medical history will be
              made only if and after a conditional offer of employment has been extended) I hereby
              release employers from <br />
              all liability In responding to Inquiries and releasing infomnaUon In connection with
        ...
        <div className="page3-content">
          ...
          <div className="row alcoDrug-ques1">
            <p>
              Has the driver participated in the RANDOM controlled substances testing program for
          ...
          <p className="alcoDrug-semiText">
            Plaese provide all of the documentation from the driver's past alcohol and drug testing
            results <br /> and documentation of participation in another/any drug testing program.
          </p>

          <div className="row alcoDrug-ques2">
            <p>
              Has the above named driver had an alcoholic test with a result of 0.04 alcohol
          ...
          <div className="row alcoDrug-ques3">
            <p>
              Has the above named driver verified positive for controlled substances test result?
            </p>
            <FormControlLabel
              label="Yes"
              control={
          ...
          <div className="row alcoDrug-ques4">
            <p>
              Has the above named driver refused a request test for alcohol or drugs during the past
              12 months?
            </p>
            <FormControlLabel
              label="Yes"
        ...
        <div className="page7-content">
          ...
          <div className="row sertOfViol">
            <p>
              If you have not been convicted of forfeited bond or collateral on account of any
              violations, please check here:
            </p>
            <FormControlLabel
              control={
                <Checkbox
        ...
        <div className="cargoTrainingAcknow">
          <div className="cargoTrainingHeadline">
            ...
            <p>
              I have been trained and instructed on the regulations for inspection, tying down and
              securing cargo that went into effect January 1, 2004. <br /> The training included:{" "}
            </p>
          </div>
        ...
        <div className="cdl-regul">
          <div className="cdl-regul-headline">
            ...
            <p>
              The Commercial Driver's License, regulations define offenses that if committed can
              cause a driver's license to be suspended, revoked, canceled or cause the driver to be
              disqualified from operating a commercial motor vehicle.
            </p>
            <p>
              I have been trained and instructed on the DOT regulations and penalties that I am
              subject to if convicted of any of the following offenses while operating a commercial
              or non-commercial motor vehicle.
            </p>
          </div>
