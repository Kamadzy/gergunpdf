...
class Page1 extends Component {
  ...
  generatePdf = () => {
    ...
    doc.text(42, 132, '5330 Madison Ave Suit F');
    doc.text(120, 132, 'Sacramento');
    doc.text(178, 132, 'CA');
    ...
    doc.text(42, 205, '5330 Madison Ave Suit F');
    doc.text(120, 205, 'Sacramento');
    doc.text(178, 205, 'CA');
    ...
    doc.text(65, 235.4, '5330 Madison Ave Suit F, Sacramento CA 95841');
